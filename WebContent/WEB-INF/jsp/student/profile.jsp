                                ...
                                <div class="card-body" style="width: 500px; margin: auto; float: none;">
                                    ...
                                    <form action="${ctx}/student/update" method="post" novalidate="novalidate">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="cc-email" name="sClassid" type="text" disabled class="form-control" value="${student.studentClassName}" data-val="true">
                                            <span class="help-block" data-valmsg-for="cc-number"
                                                  data-valmsg-replace="true"></span>
                                        </div>
                                        <div class="form-group">
                                            <label for="cc-phone" class="control-label mb-1">专业</label>
                                            <input id="cc-phone" name="sMajorid" type="text" disabled class="form-control" value="${student.studentMajorName}" data-val="true">
                                            <span class="help-block" data-valmsg-for="cc-number"
                                                  data-valmsg-replace="true"></span>
                                        </div>
                                        <div class="form-group">
