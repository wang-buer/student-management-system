                                ...
                                <div class="card-body" style="width: 500px; margin: auto; float: none;">
                                    <form action="${ctx}/course/teacherScore" method="post" novalidate="novalidate">
                                        ...
                                        <div class="form-group has-success">
                                            ...
                                            <input id="cc-score" name="scoreScore" type="text" value="${score.scoreScore}" class="form-control cc-name valid" data-val="true" data-val-required="" autocomplete="cc-name" aria-required="true" aria-invalid="false" aria-describedby="cc-name">
                                            <span class="help-block field-validation-valid" data-valmsg-for="cc-name" data-valmsg-replace="true"></span>
                                        </div>
                                        <span style="color: grey; font-size: 13px;">分值为0-100</span>
                                        <div>
