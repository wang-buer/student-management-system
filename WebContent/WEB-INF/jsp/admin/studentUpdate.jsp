                        ...
                        <div class="card-body">
                            <div id="pay-invoice">
                                <div class="card-body" style="width: 500px; margin: auto; float: none;">
                                    <form name="form1" action="${ctx}/student/adminUpdate" method="post" novalidate="novalidate">
                                        ...
                                        <div class="form-group">
                                            <label for="cc-number" class="control-label mb-1">学生编号</label>
                                        ...
                                        <div class="form-group">
                                            <label for="cc-clazz" class="control-label mb-1">班级</label>
...
<script>
	function check()
	{
		if(document.form1.studentName.value==""){alert("请输入姓名");document.form1.studentName.focus();return false;}
		if(document.form1.studentNum.value==""){alert("请输入编号");document.form1.studentNum.focus();return false;}
		if(document.form1.studentPassword.value==""){alert("请输入密码");document.form1.studentPassword.focus();return false;}
