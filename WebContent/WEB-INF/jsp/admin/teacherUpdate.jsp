    ...
    <nav class="navbar navbar-expand-sm navbar-default">
        <div id="main-menu" class="main-menu collapse navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <li>
                    <a href="${ctx}/admin/teacher"> <i class="menu-icon fa fa-clipboard"></i>学生管理</a>
                </li>
                <li>
                        ...
                        <div class="card-body">
                            <div id="pay-invoice">
                                <div class="card-body" style="width: 500px; margin: auto; float: none;">
                                    <form name="form1" action="${ctx}/teacher/adminUpdate" method="post" novalidate="novalidate">
                                        ...
                                        <div class="form-group">
                                            <label for="cc-number" class="control-label mb-1">教师编号</label>
...
<script>
	function check()
	{
		if(document.form1.teacherName.value==""){alert("请输入姓名");document.form1.teacherName.focus();return false;}
		if(document.form1.teacherNum.value==""){alert("请输入编号");document.form1.teacherNum.focus();return false;}
		if(document.form1.teacherPassword.value==""){alert("请输入密码");document.form1.teacherPassword.focus();return false;}
