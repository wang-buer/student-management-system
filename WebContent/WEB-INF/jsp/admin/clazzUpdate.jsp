                        ...
                        <div class="card-body">
                            <div id="pay-invoice">
                                <div class="card-body" style="width: 500px; margin: auto; float: none;">
                                    <form name="form1" action="${ctx}/clazz/adminUpdate" method="post" novalidate="novalidate">
...
<script>
	function check() {
		if(document.form1.clazzName.value==""){alert("请输入班级名称");document.form1.clazzName.focus();return false;}
	}
    $(function () {
